...
const BudgetCalculator = () => {
        ...
        return (
          <div key={size.id} className="flex flex-col">
            <div
              ...
              className={`relative flex items-center justify-between px-5 py-4 bg-white rounded-xl cursor-pointer transition-all duration-300 ${isSelected ? "border-[2px] border-[#C87A31] shadow-[0_10px_20px_rgba(200,122,49,0.15)] transform scale-[1.02]" : "border-[2px] border-transparent opacity-95 hover:shadow-md"}`}
            >
  ...
  const renderStep4 = () => (
    <div className="flex flex-col md:flex-row gap-8 items-center justify-center max-w-4xl mx-auto bg-white p-8 rounded-3xl shadow-sm">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-[#FAF5E9] font-poppins">
      <div className="relative w-full h-auto min-h-[600px] max-w-6xl bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-[#111111]/10 flex flex-col">
        {/* Error Modal */}
        {errorModal && (
        ...
        <div className="bg-gradient-to-b from-[#FFFFF0] to-[#EFEADA] p-6 md:p-12 flex-grow">
