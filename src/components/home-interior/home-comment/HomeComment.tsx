        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-14 flex flex-col justify-center font-poppins">
          <div className="mb-8">
            ...
            <p className="text-xs sm:text-sm text-zinc-300/90 mt-2 font-light leading-relaxed">
              Get your dream home interior budget today. Let our experts help
              you.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              className="w-full py-4 mt-2 bg-white text-[#1b332a] font-extrabold text-sm sm:text-base tracking-wider rounded-xl shadow-md hover:bg-zinc-100 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 cursor-pointer uppercase font-poppins"
            >
              Get Free Quote
            </button>
          </form>
